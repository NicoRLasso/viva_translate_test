# Generated by Django 4.0.9 on 2023-03-03 23:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.CharField(choices=[('LO', 'Local'), ('NA', 'National'), ('RE', 'Regional'), ('IN', 'International')], default='LO', max_length=2)),
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='competition_team', to='teams.teams')),
            ],
        ),
        migrations.AddConstraint(
            model_name='competition',
            constraint=models.UniqueConstraint(fields=('year', 'instance', 'team'), name='unique_record_per_team'),
        ),
    ]
